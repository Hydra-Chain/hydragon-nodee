...
These are used for the communication with third party APIs, at this moment only CoinGecko. This is because we fetch price data from it. The configuration file can be generated by running the following command:
