...
"init")
  ...
  if [ -f /data/data-1/libp2p/libp2p.key ]; then
    ...
    for i in 1 2 3 4 5; do
      ...
      "$HYDRA_NODE_BIN" secrets init --insecure --chain-id 884411 --num 5 --data-dir /data/data- --json
    done
  else
    echo "Generating secrets..."
  fi

  secrets=$("$HYDRA_NODE_BIN" secrets init --insecure --chain-id 884411 --num 5 --data-dir /data/data- --json)
